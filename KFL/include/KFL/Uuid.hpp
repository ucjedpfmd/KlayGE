...
#ifdef KLAYGE_PLATFORM_WINDOWS
		Uuid(GUID const& value) noexcept
			: data1(value.Data1), data2(value.Data2),
			  data3(value.Data3), data4{value.Data4[0], value.Data4[1], value.Data4[2], value.Data4[3], value.Data4[4], value.Data4[5],
